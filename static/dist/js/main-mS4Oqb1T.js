...
var htmx = (function() {
	...
	*/
	function removeRequestIndicators(indicators, disabled) {
		...
		forEach(indicators, function(ic) {
			if (getInternalData(ic).requestCount === 0) ic.classList.remove.call(ic.classList, htmx.config.requestClass);
		});
		forEach(disabled, function(disabledElement) {
			if (getInternalData(disabledElement).requestCount === 0) {
...
//#endregion
//#region static/js/partials/htmx.js
window.htmx = htmx;
//#endregion
...
//#endregion
//#region static/js/partials/alpine.js
window.Alpine = module_default;
document.addEventListener("DOMContentLoaded", () => {
	module_default.start();
});
//#endregion
//#region static/js/partials/layout.js
var LayoutCustomizer = class {
	constructor() {
		this.storageKey = "__SONO_CONFIG__";
		this.defaultConfig = { theme: "material" };
	...
	initEventListeners = () => {
		document.querySelectorAll("[data-theme-control]").forEach((control) => {
			control.addEventListener("click", () => {
				...
				if (value === "toggle") this.config.theme = this.config.theme === "material-dark" ? "material" : "material-dark";
				else this.config.theme = value;
				this.updateTheme();
			});
		});
	};
